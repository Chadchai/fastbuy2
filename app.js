...
const {getHome,customerSignupPage,addCustomer, customerLogin, customerLoginPage,editCustomerPage,editCustomer,productListPage,customerInbox,customerSubmit,getSupplierList,getSearchList,getAVL,getSearchAVL,saveAVL,removeAVL,sendMail,customerSummaryPage,getBiddingList,addPost,updatePost,deletePost} = require('./routes/customerlogin');
...
app.post('/addpost/:cid', addPost);
app.post('/removepost', deletePost);
